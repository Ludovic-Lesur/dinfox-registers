...
#define DMM_REGISTER_CONFIGURATION_0_MASK_NODE_SCAN_PERIOD  0x000000FF
#define DMM_REGISTER_CONFIGURATION_0_MASK_SIGFOX_UL_PERIOD  0x0000FF00
#define DMM_REGISTER_CONFIGURATION_0_MASK_SIGFOX_DL_PERIOD  0x00FF0000

#define DMM_REGISTER_STATUS_1_MASK_NODE_COUNT               0x000000FF

#define DMM_REGISTER_CONTROL_1_MASK_STRG                    0x00000001

#define DMM_REGISTER_ANALOG_DATA_1_MASK_RS485_BUS_VOLTAGE   0x0000FFFF
#define DMM_REGISTER_ANALOG_DATA_1_MASK_HMI_VOLTAGE         0xFFFF0000

#define DMM_REGISTER_ANALOG_DATA_2_MASK_USB_VOLTAGE         0x0000FFFF
