 ...
 *******************************************************************/
typedef enum {
    LVRM_REGISTER_ADDRESS_FLAGS_0 = COMMON_REGISTER_ADDRESS_LAST,
...
#define LVRM_REGISTER_FLAGS_0_MASK_BMSF                         0x00000001
#define LVRM_REGISTER_FLAGS_0_MASK_RLFH                         0x00000002

#define LVRM_REGISTER_CONFIGURATION_0_MASK_VBATT_LOW_THRESHOLD  0x0000FFFF
#define LVRM_REGISTER_CONFIGURATION_0_MASK_VBATT_HIGH_THRESHOLD 0xFFFF0000

#define LVRM_REGISTER_CONFIGURATION_1_MASK_IOUT_OFFSET          0x0000FFFF
