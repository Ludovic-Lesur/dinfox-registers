...
typedef enum {
    ...
    UHFM_REGISTER_ADDRESS_CONFIGURATION_2,
...
#define UHFM_REGISTER_CONFIGURATION_0_MASK_RF_FREQUENCY     UNA_REGISTER_MASK_ALL

#define UHFM_REGISTER_CONFIGURATION_1_MASK_TX_POWER         0x000000FF
#define UHFM_REGISTER_CONFIGURATION_1_MASK_RLBY             0x00000100
#define UHFM_REGISTER_CONFIGURATION_1_MASK_RFBY             0x00000200
#define UHFM_REGISTER_CONFIGURATION_1_MASK_RC               0x00001C00
#define UHFM_REGISTER_CONFIGURATION_1_MASK_BR               0x00002000
#define UHFM_REGISTER_CONFIGURATION_1_MASK_NFR              0x0000C000

#define UHFM_REGISTER_CONFIGURATION_2_MASK_TIFU             0x0000FFFF
#define UHFM_REGISTER_CONFIGURATION_2_MASK_TCONF            0xFFFF0000

#define UHFM_REGISTER_CONTROL_1_MASK_STRG                   0x00000001
#define UHFM_REGISTER_CONTROL_1_MASK_CMSG                   0x00000002
#define UHFM_REGISTER_CONTROL_1_MASK_MSGT                   0x0000001C
#define UHFM_REGISTER_CONTROL_1_MASK_BF                     0x00000020
#define UHFM_REGISTER_CONTROL_1_MASK_UL_PAYLOAD_SIZE        0x000007C0
#define UHFM_REGISTER_CONTROL_1_MASK_TTRG                   0x00000800
#define UHFM_REGISTER_CONTROL_1_MASK_RFP_TEST_MODE          0x0000F000
#define UHFM_REGISTER_CONTROL_1_MASK_CWEN                   0x00010000
#define UHFM_REGISTER_CONTROL_1_MASK_RSEN                   0x00020000
