 ...
 *******************************************************************/
typedef enum {
    RRM_REGISTER_ADDRESS_FLAGS_1 = COMMON_REGISTER_ADDRESS_LAST,
...
#define RRM_REGISTER_FLAGS_1_MASK_RCFH                          0x00000001

#define RRM_REGISTER_CONFIGURATION_0_MASK_OUTPUT_CURRENT_OFFSET 0x0000FFFF

#define RRM_REGISTER_STATUS_1_MASK_RCS                          0x00000003

#define RRM_REGISTER_CONTROL_1_MASK_REN                         0x00000001

#define RRM_REGISTER_ANALOG_DATA_1_MASK_INPUT_VOLTAGE           0x0000FFFF
#define RRM_REGISTER_ANALOG_DATA_1_MASK_OUTPUT_VOLTAGE          0xFFFF0000

#define RRM_REGISTER_ANALOG_DATA_2_MASK_OUTPUT_CURRENT          0x0000FFFF
