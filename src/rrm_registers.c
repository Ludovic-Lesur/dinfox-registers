...
const UNA_register_access_t RRM_REGISTER_ACCESS[RRM_REGISTER_ADDRESS_LAST] = {
...
const uint32_t RRM_REGISTER_ACCESS_TIMEOUT_MS[RRM_REGISTER_ADDRESS_LAST] = {
...
const uint32_t RRM_REGISTER_ERROR_VALUE[RRM_REGISTER_ADDRESS_LAST] = {
