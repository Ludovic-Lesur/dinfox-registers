...
const UNA_register_access_t UHFM_REGISTER_ACCESS[UHFM_REGISTER_ADDRESS_LAST] = {
...
const uint32_t UHFM_REGISTER_ACCESS_TIMEOUT_MS[UHFM_REGISTER_ADDRESS_LAST] = {
...
const uint32_t UHFM_REGISTER_ERROR_VALUE[UHFM_REGISTER_ADDRESS_LAST] = {
